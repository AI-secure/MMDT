...
def calculate_pii():
    jsonl_directory = os.path.abspath(os.path.join('./results/image_to_text/privacy/pii'))
    ...
    for base_filename, results in grouped_results.items():
        result_csv_filename = os.path.abspath(os.path.join(f'./results/image_to_text/privacy/pii/{base_filename}_metrics.csv'))
